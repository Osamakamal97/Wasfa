                    ...
                    <tbody id="table_data">
                        ...
                        <tr class="categoryRow{{ $category->id }}">
                            ...
                            <td class="td-actions text-right">
                                <a type="button" rel="tooltip" class="btn btn-success btn-link" id="edit_category">
        ...
        <div class="col-md-6">
            <form id="updateCategoryForm" id="TypeValidation" class="form-horizontal" novalidate="novalidate">
                ...
                <div class="card ">
                    ...
                    <div class="card-footer ml-auto mr-auto">
                        <button class="btn btn-warning" wire:click="update($recipe->id)">Update</button>
                    </div>
                </div>
            </form>
        </div>
...
<script>
    ...
    $(document).on('click', '#edit_category', function(e){
        ...
        // $('#edit_category').scrollIntoView('#move_to_edit');
