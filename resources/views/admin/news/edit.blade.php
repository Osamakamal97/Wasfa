        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="editNewsForm">
                    @csrf
                    @method('put')
                    <input type="text" value="{{ $single_news->id }}" name="id" style="display: none">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group bmd-form-group" style="margin-top: 52px;">
                                <label class="bmd-label-floating">Name</label>
                                <input type="text" class="form-control" name="title" value="{{ $single_news->title }}">
                    ...
                    <div class="row">
                        <div class=" col-md-12">
                            <div class="form-group bmd-form-group" style="margin-top: 52px;">
                                ...
                                <textarea class="form-control" name="content">{{ $single_news->content }}</textarea>
...
<script>
    $(document).on('click', '#update_news', function(e){
        ...
        $.ajax({
            type:'post',
            url: "{{ route('news.update', $single_news->id) }}",
            data: formData,
            processData: false,
            contentType: false,
            cache: false,
